export default function SearchBar({ city, setCity, searchWeather }) {
  return (
    <form onSubmit={searchWeather} className="flex gap-2 sm:gap-3">
      ...
      <button
        type="submit"
        className="shrink-0 rounded-lg bg-blue-600 px-4 py-2.5 text-sm font-medium text-white hover:bg-blue-700 transition sm:px-6 sm:py-3"
      >
        Search
      </button>
    </form>
